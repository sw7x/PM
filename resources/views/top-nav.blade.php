...
<head>
  ...
  <link rel="stylesheet" href="{{ URL::to('public/assets') }}/css/skins/_all-skins.min.css">
    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="{{ URL::to('') }}/index2" class="navbar-brand"><b>Admin</b>LTE</a>
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="{{ URL::to('') }}/">Back<span class="sr-only">(current)</span></a></li>
            <li><a href="#">Link</a></li>
            <li class="dropdown">
...
<!-- FastClick -->
<script src="{{ URL::to('public/assets') }}/plugins/fastclick/fastclick.js"></script>
<!-- AdminLTE App -->
