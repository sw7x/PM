...
<script src="{{ URL::to('public/assets') }}/plugins/colorpicker/bootstrap-colorpicker.min.js"></script>
...
<!-- fullCalendar 2.2.5 -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"></script>
<script src="{{ URL::to('public/assets') }}/plugins/fullcalendar/fullcalendar.min.js"></script>
