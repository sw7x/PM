          ...
          <div class="box box-primary">
            ...
            <div class="box-footer">
              <ul class="mailbox-attachments clearfix">
                ...
                <li>
                  <span class="mailbox-attachment-icon has-img"><img src="{{ URL::to('public/assets') }}/img/photo1.png" alt="Attachment"></span>
                ...
                <li>
                  <span class="mailbox-attachment-icon has-img"><img src="{{ URL::to('public/assets') }}/img/photo2.png" alt="Attachment"></span>
