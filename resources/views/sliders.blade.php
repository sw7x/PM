...
<!-- Ion Slider -->
<script src="{{ URL::to('public/assets') }}/plugins/ionslider/ion.rangeSlider.min.js"></script>
<!-- Bootstrap slider -->
<script src="{{ URL::to('public/assets') }}/plugins/bootstrap-slider/bootstrap-slider.js"></script>
